...
#unit class for the jankenpon test.
class JakenponTest < Minitest::Test
  ...
  #Function with the simple cases plu test
  ...
  #Function with the simple cases minus test
