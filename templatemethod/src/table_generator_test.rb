...
# Unit tests for the table_generator class.
class TableGeneratorTest < Minitest::Test

#Method that collect data for the testing
  def setup
    @headerEmpty = []
    @dataEmpty = []
...
# Checks that the +test_CSVTableGenerator+ method works as expected.
...
# Checks that the +test_HTMLTableGenerator+ method works as expected.
  ...
  # Checks that the +test_AsciiTableGenerator+ method works as expected.
